    ...
    <div className="bg-[#EDEDED] min-h-screen">
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-4 shadow-xs">
          <Link href="/semua-permintaan" className="hover:underline">
            Permintaan
          </Link>
          {user ? (
            <>
      ...
      <section className="min-h-screen gap-8 flex p-12 md:pt-48 md:px-24 flex-col items-center md:items-start md:justify-start bg-[#EDEDED] ">
        ...
        <div className="flex text-left flex-col gap-8 p-12 rounded-lg shadow-lg justify-start items-start bg-[#CDEBF3] min-h-[20rem] w-full">
          <div className="flex justify-between w-full items-center">
            <div className="flex justify-center items-center gap-8">
              <div className="w-50 h-50 rounded-full bg-black"></div>
              <div className="flex flex-col gap-2">
                <h1 className="text-[#322C2C] font-bold text-5xl text-start">
                  {user ? user.name : "User"}
                </h1>
                <h1 className="text-[#322C2C] font-bold text-3xl text-start">
                  Dompetku : Rp.0000
                </h1>
                <h1 className="text-[#322C2C] font-bold text-3xl text-start">
                  Nomor Telepon : Rp.0000
                </h1>
              </div>
            </div>
            <LogoutButton />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {Array(6)
            ...
            .map((_, index) => (
              <div
                key={index}
                className="bg-[#F8FAFA] h-[500px] w-full shadow-lg rounded-2xl flex flex-col gap-4"
              >
