...
interface PermintaanDetailPageProps {
  params: { id: string }; // Define the type for params explicitly
}

export default async function PermintaanDetailPage({ params }: PermintaanDetailPageProps) {
  ...
  return (
    <div>
      ...
      <div className="max-w-xl mx-auto p-8">
        ...
        <div className="mb-2">Urgensi: {quest.tingkat_kedaruatan}</div>
