...
export default function Home() {
  return (
    <div>
      <Navbar />
      <main className="main-section bg-[url('/images/background-home-desktop.svg')] bg-center bg-cover flex min-h-screen min-w-screen flex-col items-center justify-center">
      ...
      <section className="relative flex justify-center bg-[#D3E6EC] pb-4">
        ...
        <div className="mengapa-section flex flex-col items-center">
          <div className="z-10 h-1/6 bg-black hidden sm:grid md:hidden lg:hidden xl:hidden grid-cols-1 md:grid-cols-3 rounded-2xl justify-between items-center w-[70%] md:w-[80%] gap-2">
          ...
          <div className="lg:mt-12 relative z-20 w-screen h-screen flex justify-between">
            ...
            <div className="w-full h-screen flex items-center">
              <div className="md:mt-48 flex flex-col gap-12 w-full h-full justify-center items-center xl:items-start">
                <div className="w-50 h-1 bg-gradient-to-l from-black to-transparent"></div>
                <h1 className="z-30 text-5xl text-[#484848] text-center xl:text-start font-bold">
                  Mengapa TolongYuk?
                </h1>
                <p className="text-center xl:text-start text-2xl w-[80%] xl:w-[60%]">
